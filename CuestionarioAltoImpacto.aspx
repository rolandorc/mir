<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="CuestionarioAltoImpacto.aspx.cs" Inherits="MIR.CuestionarioAltoImpacto" %>
...
<form class='formsave'>
        <div class='form-group'> 
            <div class='form-block same-group'>                  
                <h2>Cuestionario de Alto Impacto</h2>
                <br />
                <div class='form-group'> 
                    <div class='row'>
                        <div class='col-lg-12'>
                    ...
                    <div class='row'>
                        <div class='col-lg-12'> 
                            <textarea rows='1' class='form-control mediumbold normaltext' id='AltoImpactoq1' disabled>Describa los objetivos generales de la regulación</textarea>  
                        </div>
                    </div>
                    <div class='row'> 
                        <div class='col-lg-12'>
                ...
                <div class='form-group'> 
                    ...
                    <div class='row'>
                        <div class='col-lg-12'> 
                            <textarea rows='2' class='form-control mediumbold normaltext' id='AltoImpactoq11' disabled>Justifique las razones por las que la regulación propuesta es considerada la mejor opción para atender la problemática señalada</textarea>  
                        </div>
                    </div>
                    <div class='row'> 
                        <div class='col-lg-12'>
                     ...
                     <div class='row'>
                        <div class='col-lg-12'> 
                            <textarea rows='2' class='form-control mediumbold normaltext' id='AltoImpactoq12' disabled>Describa la forma en que la problemática se encuentra regulada en otros países y/o las buenas prácticas internacionales en esta materia</textarea>  
                        </div>
                    </div>
                    <div class='row'> 
                        <div class='col-lg-12'>
                            <textarea rows='6' class='form-control normaltext' id='textAltoImpactoq12' name="textAltoImpactoq12" placeholder='....' required></textarea>
                        </div>
                    </div>
                     <div class='row'>
                        <div class='col-lg-10'>
                    ...
                    <div class='row'>
                        <div class='col-lg-10'> 
                            <textarea rows='2' class='form-control mediumbold normaltext' id='AltoImpactoq13' disabled>¿La regulación propuesta contiene disposiciones en materia de salud humana, animal o vegetal, seguridad, trabajo, medio ambiente o protección a los consumidores?</textarea>  
                        </div>
                        <div class='col-lg-1'>
                    ...
                    <div class='row'>
                        <div class='col-lg-12'> 
                            <textarea rows='1' class='form-control mediumbold normaltext' id='AltoImpactoq14' disabled>Población o industria potencialmente afectada</textarea>  
                        </div>
                    </div>
                    <div class='row'> 
                        <div class='col-lg-12'>
                            <textarea rows='6' class='form-control normaltext' id='textAltoImpactoq14' name="textAltoImpactoq14" placeholder='....' required></textarea>
                        </div>
                    </div> 
                     <div class='row'>
                        <div class='col-lg-12'> 
                            <textarea rows='1' class='form-control mediumbold normaltext' id='AltoImpactoq15' disabled>Origen y área geográfica del riesgo</textarea>  
                        </div>
                    </div>
                    <div class='row'> 
                        <div class='col-lg-12'>
                            <textarea rows='6' class='form-control normaltext' id='textAltoImpactoq15' name="textAltoImpactoq15" placeholder='....' required></textarea>
                        </div>
                    </div> 
                   <div class='row'>
                        <div class='col-lg-12'> 
                            <textarea rows='1' class='form-control mediumbold normaltext' id='AltoImpactoq16' disabled>Justifique cómo la regulación puede mitigar el riesgo</textarea>  
                        </div>
                    </div>
                    <div class='row'> 
                        <div class='col-lg-12'>
                            <textarea rows='6' class='form-control normaltext' id='textAltoImpactoq16'  name="textAltoImpactoq16" placeholder='....' required></textarea>
                        </div>
                    </div> 
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div id="tableDisposiciones" class="table-editable"  style="word-break: break-all">
                                ...
                                <table class="table table-bordered table-responsive-md table-striped text-center">
                                    <tr>
                                        <th class="text-center"  style="width:33%"><h6><strong>Disposiciones, Acciones u Obligaciones</strong></h6></th>
                                        <th class="text-center"  style="width:33%"><h6><strong>Artículos Aplicables</strong></h6></th>
                                        <th class="text-center"  style="width:33%"><h6><strong>Justificación</strong></h6></th>
                    ...
                    <div class='row'>
                        <div class='col-lg-12'> 
                            <textarea rows='2' class='form-control mediumbold normaltext' id='AltoImpactoq18' disabled>¿Cuales serían los efectos de la regulación sobre la competencia y libre concurrencia en los mercados, así como sobre el comercio nacional e internacional?</textarea>  
                        </div>
                    </div>
                    <div class='row'> 
                        <div class='col-lg-12'>
                            <textarea rows='6' class='form-control normaltext' id='textAltoImpactoq18' name="textAltoImpactoq18" placeholder='....' required></textarea>
                        </div>
                    </div> 

                   <div class='row'>
                        <div class='col-lg-12'> 
                            <textarea rows='2' class='form-control mediumbold normaltext' id='AltoImpactoq19' disabled>¿Cuales serían los efectos de la regulación propuesta sobre los precios, calidad y disponibilidad de bienes y servicios para el consumidor en los mercados?</textarea>  
                        </div>
                    </div>
                    <div class='row'> 
                        <div class='col-lg-12'>
                            <textarea rows='6' class='form-control normaltext' id='textAltoImpactoq19' name="textAltoImpactoq19" placeholder='....' required></textarea>
                        </div>
                    </div> 
                    <div class='row'>
                        <div class='col-lg-12'> 
                            <textarea rows='2' class='form-control mediumbold normaltext' id='AltoImpactoq20' disabled>¿La propuesta de regulación contempla esquemas que impactan de manera diferenciada a sectores industria o agentes económicos? (ejemplo a las micro, pequeñas o medianas empresas)</textarea>  
                        </div>
                    </div>
                    <div class='row'> 
                        <div class='col-lg-12'>
                            <textarea rows='6' class='form-control normaltext' id='textAltoImpactoq20' name="textAltoImpactoq20"  placeholder='....' required></textarea>
                        </div>
                    </div> 
                    ...
                    <!-- Editable table -->
                     <div class='row'>
                        <div class='col-lg-12'> 
                            <textarea rows='2' class='form-control mediumbold normaltext' id='AltoImpactoq29' disabled>Justifique que los beneficios de la regulación son superiores a sus costos</textarea>  
                        </div>
                    </div>
                    <div class='row'> 
                        <div class='col-lg-12'>
                            <textarea rows='6' class='form-control normaltext' id='textAltoImpactoq29'  name="textAltoImpactoq29"  placeholder='....' required></textarea>
                        </div>
                    </div>
                 ...
                 <div class='form-group'> 
                    ...
                    <div class='row'>
                        <div class='col-lg-12'> 
                            <textarea rows='1' class='form-control mediumbold normaltext' id='AltoImpactoq21' disabled>Describa la forma y/o los mecanismos a través de los cuales se implementará la regulación (incluya recursos públicos)</textarea>  
                        </div>
                    </div>
                    <div class='row'> 
                        <div class='col-lg-12'>
                            <textarea rows='6' class='form-control normaltext' id='textAltoImpactoq21' name="textAltoImpactoq21" placeholder='....' required></textarea>
                        </div>
                    </div> 
                   <div class='row'>
                        <div class='col-lg-12'> 
                            <textarea rows='2' class='form-control mediumbold normaltext' id='AltoImpactoq22' disabled>Describa los esquemas de verificación y vigilancia, así como las sanciones que aegurarán el cumplimiento de la regulación</textarea>  
                        </div>
                    </div>
                    <div class='row'> 
                        <div class='col-lg-12'>
                            <textarea rows='6' class='form-control normaltext' id='textAltoImpactoq22' name="textAltoImpactoq22" placeholder='....' required></textarea>
                        </div>
                    </div> 
                </div>
                ...
                <div class='form-group'> 
                    ...
                    <div class='row'>
                        <div class='col-lg-12'> 
                            <textarea rows='1' class='form-control mediumbold normaltext' id='AltoImpactoq25' disabled>Describa la forma y los medios a través de los cuales se evaluará el logro de los objetivos de la regulación</textarea>  
                        </div>
                    </div>
                    <div class='row'> 
                        <div class='col-lg-12'>
                            <textarea rows='6' class='form-control normaltext' id='textAltoImpactoq25' name="textAltoImpactoq25" placeholder='....' required></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class='form-group'> 
                 ...
                 <div class='form-group'> 
                    <div class='row'>
                        <div class='col-lg-12'> 
                            <textarea rows='2' class='form-control mediumbold normaltext' id='AltoImpactoq26' disabled>Indique las propuestas que se incluyeron en la regulación como resultado de las consultas realizadas</textarea>  
                        </div>
                    </div>
                    <div class='row'> 
                        <div class='col-lg-12'>
                            <textarea rows='6' class='form-control normaltext' id='textAltoImpactoq26' name="textAltoImpactoq26" placeholder='....' required></textarea>
                        </div>
                    </div>
                </div>
                                    <div class='row'> 
...
<asp:Content ID="Content3" ClientIDMode="Static" ContentPlaceHolderID="scripts" runat="server">
    <script src="Scripts/ScriptForm/CuestionarioAltoImpacto.js?v=1.8"></script>
</asp:Content>