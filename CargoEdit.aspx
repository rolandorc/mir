<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="CargoEdit.aspx.cs" Inherits="MIR.CargoEdit" %>
...
<asp:Content ID="Content3" ClientIDMode ="Static" ContentPlaceHolderID="scripts" runat="server">
    ...
    <script src="Scripts/ScriptForm/CargoEdit.js?v=1.1"></script>
</asp:Content>